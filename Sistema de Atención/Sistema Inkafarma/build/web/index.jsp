            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-3 col-md-offset-2">                       
                        <a href="registroTicket.jsp" role="button" class="btn btn-primary btn-lg btn-success btn-block">Abrir Nuevo Ticket</a>
                    </div>
                    <div class="col-md-3 col-md-offset-2">
                        <a href="estadoTicket.jsp" role="button" class="btn btn-primary btn-lg btn-success btn-block">Ver Estado de Ticket</a>
                    </div>
                </div>
            </div>
        </article>
