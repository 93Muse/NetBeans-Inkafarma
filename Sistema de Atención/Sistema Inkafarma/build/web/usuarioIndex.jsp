...
<html>
    ...
    <body>
        <div id="wrap">
            <%@include file="WEB-INF/jspf/userMain.jspf" %>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-3 col-md-offset-2">                       
                            <a href="usuarioCrear.jsp" role="button" class="btn btn-lg btn-success btn-block">Abrir Nuevo Ticket</a>
                        </div>
                        <div class="col-md-3 col-md-offset-2">
                            <a href="usuarioTickets.jsp" role="button" class="btn btn-lg btn-success btn-block">Ver Estado de Ticket</a>
                        </div>
                    </div>
                </div>
            </div>
